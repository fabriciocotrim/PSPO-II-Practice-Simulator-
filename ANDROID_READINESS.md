# Android readiness — v2.3.0

## Estado

A v2.3.0 está pronta para teste como PWA no GitHub Pages e preparada para uma próxima etapa de empacotamento Android.

## Caminho recomendado

1. Testar v2.3.0 no GitHub Pages.
